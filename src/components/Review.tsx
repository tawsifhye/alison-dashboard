        ...
        <Box sx={{
            ...
            <Box sx={{
                ...
                <Typography sx={{
                    ...
                    Your Score: <Box component='span' sx={{ fontWeight: 700, color: '#3F4A52' }}>{percentage}%</Box>
                </Typography>
                        ...
                        quizzes[quizIndex]?.options.map((option: Option) => (
                            <Box
                                ...
                                sx={{
                                    ...
                                    border: submittedAnswer[quizIndex].selectedAnswer === option.id ? '2px solid white' : '2px solid transparent',
                                    marginBottom: '20px',
                                    color: ' #fff',
                                    position: 'relative',
                                    fontSize: '18px',
                ...
                >
                    {
                        submittedAnswer[quizIndex].selectedAnswer === quizzes[quizIndex]?.right_answer ?
                            <>
                                <DoneIcon sx={{
                                    ...Styles.icon,
                                    left: '10px',
                ...
                <Button sx={{ ...primaryButton, mx: 'auto', mt: 5 }}
                    variant='contained'
                    disableRipple
