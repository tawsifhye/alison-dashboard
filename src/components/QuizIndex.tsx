    ...
    return (
        <>
            <Typography sx={{
                ...
                {index < 3 && 'You must pass all Assessments in this course to get your official Certification. Let’s go!'}
                {(index <= 4 && index > 2) && 'You’ve done over 25% of the Assessment! Well Done!'}
